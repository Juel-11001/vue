    ...
    >
      ...
      >
        ...
        <div class="py-4 text-left px-6">
          ...
          <ul class="flex flex-wrap mb-4">
            <li class="flex-auto text-center">
              <a
                ...
                href="#" @click.prevent="tab='login'" :class="{'hover:text-white text-white bg-blue-600': tab==='login', 'hover:text-blue-400': tab==='register'}">Login</a
              >
            </li>
            <li class="flex-auto text-center">
              <a class="block rounded py-3 px-4 transition" href="#" @click.prevent="tab='register'" :class="{'hover:text-white text-white bg-blue-600': tab==='register', 'hover:text-blue-400': tab==='login'}"
              >Register</a
              >
            </li>
          </ul>
          ...
          <!-- Registration Form -->
          <vee-form v-show="tab==='register'" :validation-schema="schema" @submit="submitForm" :initial-values="userData">
            <!-- Name -->
            <div class="mb-3">
